...
git clone --single-branch --branch gh-pages https://kamil-nowocin:$GITHUB:TOKEN@github.com/kamil-nowocin/Test_Automation-automationpractice target/github-pages
sleep 5
